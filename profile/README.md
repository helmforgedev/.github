...
The project currently maintains **113 Helm charts** across databases, messaging, identity, automation, education, CMS, analytics, AI tooling, networking, observability, and self-hosted applications. Charts are published through both a classic HTTPS Helm repository and OCI artifacts on GHCR.
...
- **Day-2 patterns included** - 42 charts include optional S3-compatible backup workflows, and charts document operational boundaries clearly.
...
| Area | Current state |
|------|---------------|
| Charts | 113 chart packages |
| Stable charts | 113 stable charts |
