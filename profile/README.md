...
The project currently maintains **87 Helm charts** across databases, messaging, identity, automation, CMS, analytics, AI tooling, networking, observability, and self-hosted applications. Charts are published through both a classic HTTPS Helm repository and OCI artifacts on GHCR.
...
| Area | Current state |
|------|---------------|
| Charts | 87 chart packages |
| Stable charts | 84 stable charts |
